...
import 'package:Vinove_Assignment/route_screen.dart';
import 'Member.dart';

class LocationHistoryScreen extends StatefulWidget {
  final Member member;

  const LocationHistoryScreen(this.member, {super.key});
...
Widget _buildTimelineTile(BuildContext context, String title, String subtitle, bool isFirst) {
  return ListTile(
    leading: Column(
      ...
      children: [
        const Icon(Icons.circle, color: Color(0xFF42329E), size: 10),
        if (!isFirst) Container(height: 40, width: 2, color: const Color(0xFF42329E)),
      ],
    ),
    title: Text(
      title,
